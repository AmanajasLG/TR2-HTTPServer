/****************************************************************************
** Meta object code from reading C++ file 'socketClient.hpp'
**
...
#error "The header file 'socketClient.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_SocketClient[] = {
    "SocketClient\0\0buffer\0IncomingResponse(char*)\0"
    "SendRequest(char*)\0"
};
...
void SocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->IncomingResponse((*reinterpret_cast< char*(*)>(_a[1]))); break;
        case 1: _t->SendRequest((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject SocketClient::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SocketClient,
...
// SIGNAL 0
void SocketClient::IncomingResponse(char * _t1)
{
